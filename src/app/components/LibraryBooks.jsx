    ...
    <div className="for-you__recommended--books">
      <Swiper
        breakpoints={{
          ...
          440: {
            slidesPerView: books.length > 5 ? 2 : books.length,
          },
          768: {
            slidesPerView: books.length > 5 ? 3 : books.length,
          },
          1024: {
            slidesPerView: books.length > 5 ? 4 : books.length,
          },
          1200: {
            slidesPerView: books.length > 5 ? 5 : books.length,
          },
        }}
        slidesPerView={"auto"}
        spaceBetween={5}
